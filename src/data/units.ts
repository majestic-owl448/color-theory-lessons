...
export const units: UnitConfig[] = [
  ...
  { id: 'unit-2', title: 'Additive and Subtractive Color', description: 'Understand light-based and pigment-based color models.', badgeTitle: 'Screen Mixer', lessons: ['u2-l1', 'u2-l2'], milestoneId: 'milestone-2' },
