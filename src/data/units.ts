...
export const units: UnitConfig[] = [
  { id: 'unit-1', title: 'Seeing and Describing Color', description: 'Build your visual vocabulary for color.', badgeTitle: 'Color Observer', lessons: [], milestoneId: 'milestone-1' },
  { id: 'unit-2', title: 'Additive and Subtractive Color', description: 'Understand light-based and pigment-based color models.', badgeTitle: 'Screen Mixer', lessons: [], milestoneId: 'milestone-2' },
