...
export const units: UnitConfig[] = [
  ...
  { id: 'unit-2', title: 'Additive and Subtractive Color', description: 'Understand light-based and pigment-based color models.', badgeTitle: 'Screen Mixer', lessons: ['u2-l1', 'u2-l2', 'u2-l3', 'u2-l4', 'u2-l5', 'u2-l6'], milestoneId: 'milestone-2' },
  { id: 'unit-3', title: 'Digital Color in Programming', description: 'Master HEX, RGB, HSL, and alpha in code.', badgeTitle: 'UI Color Coder', lessons: ['u3-l1', 'u3-l2', 'u3-l3', 'u3-l4', 'u3-l5', 'u3-l6', 'u3-l7'], milestoneId: 'milestone-3' },
