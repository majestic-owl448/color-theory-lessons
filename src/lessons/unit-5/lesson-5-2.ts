...
export const lesson5_2: LessonConfig = {
  ...
  estimatedMinutes: 16,
  prerequisites: ['u5-l1'],
  conceptsIntroduced: ['text contrast', 'normal text', 'large text', 'contrast ratio', 'pass', 'fail'],
  ...
  steps: [
    { id: 's1', text: 'Text readability depends more on lightness contrast than on hue. A light gray label on a white card feels elegant, but if the luminance difference is too small, many users will struggle to read it.', highlights: ['text contrast', 'contrast ratio'] },
