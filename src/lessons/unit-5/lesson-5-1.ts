...
export const lesson5_1: LessonConfig = {
  ...
  estimatedMinutes: 13,
  prerequisites: ['u4-l6'],
  conceptsIntroduced: ['accessibility', 'state indicator', 'usability', 'visual affordance'],
  ...
  steps: [
    ...
    { id: 's4', text: 'Unit 4 showed how color-only state signals fail under CVD simulation. Now consider the broader usability impact: a red error message, a green success badge, or a blue selected state — when color is the only cue, any user who cannot distinguish those colors is blocked.', highlights: ['color-only meaning', 'state indicator'] },
