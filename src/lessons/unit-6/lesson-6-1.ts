...
export const lesson6_1: LessonConfig = {
  ...
  estimatedMinutes: 15,
  prerequisites: ['u5-l6'],
  conceptsIntroduced: ['color system', 'consistency', 'semantic role'],
  ...
  steps: [
    ...
    { id: 's2', text: 'A color system gives colors jobs. Instead of choosing what looks nice in isolation, you assign roles: page background, card surface, primary text, secondary text, divider, action, success, warning, error.', highlights: ['semantic role'] },
