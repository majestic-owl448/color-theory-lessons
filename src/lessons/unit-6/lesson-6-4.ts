...
export const lesson6_4: LessonConfig = {
  ...
  steps: [
    ...
    { id: 's2', text: 'Dark theme backgrounds are typically a very dark but not pure-black neutral — something in the range of #0f172a to #1e293b. This softens glare and gives space for darker card and panel layers above it.', highlights: ['surface depth', 'tonal separation'] },
    { id: 's3', text: 'Text in dark mode is usually a soft off-white rather than pure white. Primary text might be #f8fafc while secondary text is #94a3b8 — still high contrast against the dark surface, but less fatiguing than full-brightness white.', highlights: ['inverse text'] },
