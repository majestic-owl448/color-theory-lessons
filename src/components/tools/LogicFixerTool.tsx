...
const SCENARIOS: Scenario[] = [
  ...
  {
    wrong: 'This blue looks too dark. I need to mix in some black to deepen it.',
    context: 'A designer is trying to darken a button color and describing their approach.',
    choices: [
      {
        id: 'a',
        label: 'Adding black pigment will absorb more wavelengths and deepen the screen color.',
        isCorrect: false,
        explanation: 'Screens have no pigment to add. Absorption is a physical-material concept.',
      },
      {
        id: 'b',
        label: 'Lower the blue channel value to reduce its light intensity and darken the color.',
        isCorrect: true,
        explanation: 'On screen, darker means less light — lower channel values. No mixing is involved.',
      },
      {
        id: 'c',
        label: 'Mix in a gray swatch to dilute the color and reduce its brightness.',
        isCorrect: false,
        explanation: '"Diluting" is a paint concept. Screen colors are adjusted by changing channel numbers.',
      },
      {
        id: 'd',
        label: 'Reduce all channels equally so the color becomes more neutral.',
        isCorrect: false,
        explanation: 'Reducing all channels equally shifts to a darker gray, not a darker version of the original hue.',
      },
    ],
  },
  {
